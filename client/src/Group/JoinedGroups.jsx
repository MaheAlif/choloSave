            ...
            <div className="flex flex-col lg:flex-row gap-3 bg-slate-100 p-2 rounded-xl border-2 border-gray-400">
              ...
              <div className="border w-3/12 border-green-500 rounded-xl p-1">
                <img
                  ...
                  src="https://easy-peasy.ai/cdn-cgi/image/quality=80,format=auto,width=700/https://fdczvxmwwjwpwbeeqcth.supabase.co/storage/v1/object/public/images/f383cda8-0c5c-4579-9606-0df72fcb9aee/1085f340-bfeb-424e-a9d5-723d1f63d29b.png"
                  alt=""
                />
              </div>
              {/* Group Info */}
