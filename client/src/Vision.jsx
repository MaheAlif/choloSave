...
const Vision = () => {
  return (
    <>
      <div
      id="vision"
        className="flex flex-col p-2 lg:p-10  lg:flex-row-reverse gap-2 lg:gap-5 justify-center  border-purple-500 min-h-[500px] bg-gradient-to-r from-indigo-900 via-purple-500 to-pink-500 bg-opacity-5"
        style={{
          backgroundImage: {},
        }}
      >
        <div className="lg:w-1/2 p-3 lg:ml-32 border-pink-400 flex flex-col gap-3 justify-center align-middle">
          ...
          <p className="text-sm lg:text-[15px] text-white font-normal">
            Our vision is to foster collaborative financial growth by enabling
            groups to save, invest, and achieve shared goals through
            transparency, innovation, and trust.
          </p>
        ...
        <div className="lg:w-1/2 relative  border-pink-400">
          ...
          <div className="   min-h-full w-full  flex gap-3 lg:flex-row text-center justify-center align-middle">
            <img className="max-h-[400px] max-w-[300px]" src={P1} alt="" />
            <div className="flex flex-col gap-2">
              <img className="min-h-[200px] lg:max-w-[300px]" src={P2} alt="" />
              <img className="min-h-[200px] lg:max-w-[300px]" src={P3} alt="" />
            </div>
          </div>
